...
echo "=========================================="
echo "Qt 50プロジェクトデータ収集"
echo "=========================================="
echo ""

# 設定
GERRIT_URL="https://codereview.qt-project.org"
START_DATE="2021-01-01"
END_DATE="2024-01-01"
OUTPUT_FILE="data/qt_50proj_2021_2024.csv"
PROJECT_LIST="projects_qt_50.txt"
...
echo "2. マルチプロジェクト特徴量追加: uv run python scripts/pipeline/add_multiproject_features.py --input ${OUTPUT_FILE} --output data/qt_50proj_2021_2024_feat.csv"
echo "3. IRL学習: uv run python scripts/train/train_cross_temporal_multiproject.py --train-csv data/qt_50proj_2021_2024_feat.csv --train-year 2021 --test-year 2023 --output-dir outputs/qt_50projects_irl"
echo ""
