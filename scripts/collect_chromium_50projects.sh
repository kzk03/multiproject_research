...
END_DATE="2024-01-01"
OUTPUT_FILE="data/chromium_50proj_2021_2024.csv"
PROJECT_LIST="projects_chromium_50.txt"
...
echo "2. マルチプロジェクト特徴量追加: uv run python scripts/pipeline/add_multiproject_features.py --input ${OUTPUT_FILE} --output data/chromium_50proj_2021_2024_feat.csv"
echo "3. IRL学習: uv run python scripts/train/train_cross_temporal_multiproject.py --train-csv data/chromium_50proj_2021_2024_feat.csv --train-year 2021 --test-year 2023 --output-dir outputs/chromium_50projects_irl"
echo ""
