...
class RetentionIRLSystem:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        # ========================================
        self.state_dim = config.get('state_dim', 10)  # Nova単体: 10次元
        self.action_dim = config.get('action_dim', 4)  # Nova単体: 4次元
    ...
    def extract_developer_state(self,
        ...
        return DeveloperState(
            ...
            # マルチプロジェクト対応: 新しい特徴量（Nova単体では使用しない）
    ...
    def state_to_tensor(self, state: DeveloperState) -> torch.Tensor:
        """状態をテンソルに変換（10次元版 - Nova単体プロジェクト用）"""
